    ...
    const fetchcommingsoon = async () => {
      try {
        const response = await fetch(
          "http://localhost:4000/movie/commingsoon"
        );
        const data = await response.json();
        setCommingsoon(data.commingsoon);
        console.log("Now showing movies:", data.commingsoon);
      } catch (error) {
        console.error("Error fetching now commingsoon movies:", error);
      }
    };
      ...
      <div className="row">
        <div className="col-12">
          <h2 className="section__title">
            <a href="category.html">Comming Soon</a>
          </h2>
        </div>

        <div className="col-12">
          <div className="section__carousel-wrap">
            <div className="section__carousel owl-carousel"
            style={{
              display: "flex",
              gap: '4rem'
          }}
            id="popular">
              ...
              <div className="card ">
                      ...
                      <h3 className="card__title">
                        <Link to="/moviedetails">The Good Lord Bird</Link>
                      </h3>
