    ...
    const fetchNextrelease = async () => {
      try {
        const response = await fetch(
          "http://localhost:4000/movie/nextrelease"
        );
        const data = await response.json();
        setNextrelease(data.nextrealese);
        console.log("Now showing movies:", data.nextrealese);
      } catch (error) {
      ...
      <div className="row">
        <div className="col-12">
          <h2 className="section__title">
            <a href="category.html">Next Release</a>
          </h2>
        </div>
