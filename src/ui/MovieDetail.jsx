			...
			<div className="article">
				<div className="row">
					<div className="col-12 col-xl-8">
						{/* <!-- trailer --> */}
						<Link to="/booking">
							<div  className="article__trailer open-video">
					...
					<div className="col-12 col-xl-8">
						<div className="plyr__video-embed" id="player">
							...
							<iframe width="560" height="315" src="https://www.youtube.com/embed/5dp_AKwv5vI?si=_Qdzy-zI1XePrRLX" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
						  </div>
